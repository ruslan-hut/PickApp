        ...
        return Room.databaseBuilder(
            ...
            .addCallback(object : RoomDatabase.Callback() {
                ...
                private fun insertProductBarcodes(db: SupportSQLiteDatabase) {
                    ...
                    db.execSQL(insertSql, arrayOf("bc_sku_001", "prod_001", "SKU001", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_002", "prod_002", "SKU002", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_003", "prod_003", "SKU003", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_004", "prod_004", "SKU004", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_005", "prod_005", "SKU005", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_006", "prod_006", "SKU006", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_007", "prod_007", "SKU007", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_008", "prod_008", "SKU008", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_009", "prod_009", "SKU009", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_010", "prod_010", "SKU010", "CODE128", 0))
                    db.execSQL(insertSql, arrayOf("bc_sku_011", "prod_011", "SKU011", "CODE128", 0))
                }
            })
            .build()
    }
